...
export const paginasRevisao: PaginaRevisao[] = [
  ...
  },
  {
    ...
    grupo: "Páginas do site",
    secoes: [
      { id: "solucao-atrativa-e-eficiente", titulo: "Conforto, proteção e privacidade para seu ambiente." },
      { id: "principais-beneficios", titulo: "Principais benefícios" },
      { id: "tipos-de-peliculas", titulo: "Tipos de películas arquitetônicas" },
      { id: "distribuicao", titulo: "Películas e soluções para aplicadores" },
      { id: "alguns-dos-nossos-trabalhos", titulo: "Alguns dos nossos trabalhos" },
      { id: "credenciada-3m-acesso", titulo: "Credenciada 3M (acesso para a página da 3M)" },
      { id: "venha-nos-fazer-uma-visita", titulo: "Venha nos visitar." },
    ],
  },
  {
